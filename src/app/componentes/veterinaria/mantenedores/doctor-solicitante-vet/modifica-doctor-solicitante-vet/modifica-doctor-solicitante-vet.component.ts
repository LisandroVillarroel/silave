...
@Component({
  selector: 'app-modifica-doctor-solicitante-vet',
  templateUrl: './modifica-doctor-solicitante-vet.component.html',
  styleUrls: ['./modifica-doctor-solicitante-vet.component.css']
})
export class ModificaDoctorSolicitanteVetComponent implements OnInit {
    ...
    constructor(private dialogRef: MatDialogRef<ModificaDoctorSolicitanteVetComponent>,
