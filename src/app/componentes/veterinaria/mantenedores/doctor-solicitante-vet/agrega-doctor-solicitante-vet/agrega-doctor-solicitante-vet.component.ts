...
@Component({
  selector: 'app-agrega-doctor-solicitante-vet',
  templateUrl: './agrega-doctor-solicitante-vet.component.html',
  styleUrls: ['./agrega-doctor-solicitante-vet.component.css']
})
export class AgregaDoctorSolicitanteVetComponent implements OnInit {
  ...
  constructor(private dialogRef: MatDialogRef<AgregaDoctorSolicitanteVetComponent>,
