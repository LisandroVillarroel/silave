  ...
  @Component({
    selector: 'app-imprime-pruebas-de-coagulacion',
    templateUrl: './imprime-pruebas-de-coagulacion.component.html',
    styleUrls: ['./imprime-pruebas-de-coagulacion.component.css']
  })

  export class ImprimePruebasDeCoagulacionComponent implements AfterViewInit {
    ...
    constructor(public fichaService: FichaService,private dialogRef: MatDialogRef<PruebasDeCoagulacionComponent>,
