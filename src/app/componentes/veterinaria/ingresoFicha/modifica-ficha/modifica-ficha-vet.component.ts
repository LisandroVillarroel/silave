...
@Component({
  selector: 'app-modifica-ficha-vet',
  templateUrl: './modifica-ficha-vet.component.html',
  styleUrls: ['./modifica-ficha-vet.component.css']
})
export class ModificaFichaVetComponent implements OnInit {
    ...
    constructor(private dialogRef: MatDialogRef<ModificaFichaVetComponent>,
